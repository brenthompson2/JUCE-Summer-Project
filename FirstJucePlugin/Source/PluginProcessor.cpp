...
//==============================================================================
const String FirstJucePluginAudioProcessor::getName() const
{
...
const String FirstJucePluginAudioProcessor::getProgramName (int index)
{
    return {};
}

void FirstJucePluginAudioProcessor::changeProgramName (int index, const String& newName)
{
}
...
void FirstJucePluginAudioProcessor::processBlock (AudioSampleBuffer& buffer, MidiBuffer& midiMessages)
{
...
AudioProcessorEditor* FirstJucePluginAudioProcessor::createEditor()
{
    return new FirstJucePluginAudioProcessorEditor (*this);
}

//==============================================================================
void FirstJucePluginAudioProcessor::getStateInformation (MemoryBlock& destData)
{
